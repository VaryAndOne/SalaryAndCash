 ...
 * @since 9/24/2016
 */
public class CatchAdapter extends RecyclerView.Adapter<CatchAdapter.Holder> {

    private LayoutInflater mLayoutInflater;
    private List<Salary> mCakeList = new ArrayList<>();

    public CatchAdapter(LayoutInflater inflater) {
        mLayoutInflater = inflater;
    }

    @Override
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_food, parent, false);
